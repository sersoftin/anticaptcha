...
class Base64ImageToTextTask(object):
    type = "ImageToTextTask"
    base64Image = None
    phrase = None
    case = None
    ...
    def __init__(self, base64_image, phrase=None, case=None, numeric=None, math=None, min_length=None, max_length=None):
